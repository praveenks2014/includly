...
export const paymentPlanEnum = pgEnum("payment_plan", ["plan_a_subscription", "plan_b_per_contact", "plan_c_featured", "plan_d_pro_onetime", "plan_e_pro_monthly", "plan_f_per_booking", "plan_session_pass_5", "plan_session_pass_10", "plan_placement_fee", "plan_activation_fee"]);
