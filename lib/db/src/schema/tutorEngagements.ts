...
export const tutorEngagementsTable = pgTable("tutor_engagements", {
  ...
  // Block-only weekly commitment, captured from the TUTOR at accept time —
  ...
  // tutor_engagement_sessions; this column is for the agreed commitment used
  // in candidate-matching exclusion and parent-facing display, not for
