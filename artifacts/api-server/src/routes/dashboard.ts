    ...
    return {
      ...
      professional: p
        ? {
            ...
            phoneBlurred: p.specialty === "shadow_teacher" ? null : blurContact(p.phone),
            emailBlurred: p.specialty === "shadow_teacher" ? null : blurContact(p.email),
            isUnlocked: p.specialty !== "shadow_teacher",
            phone: p.specialty === "shadow_teacher" ? null : p.phone,
            email: p.specialty === "shadow_teacher" ? null : p.email,
