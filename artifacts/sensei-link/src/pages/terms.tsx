      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <Section title="1. Acceptance of Terms">
            <p>By accessing or using Includly ("the Platform"), you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree to these terms, please do not use the Platform.</p>
          </Section>

          <Section title="2. Description of Service">
            <p>Includly is an online marketplace that connects parents and guardians ("Parents") with special education professionals and medical specialists ("Professionals"). We provide a platform for discovery and contact — we are not a party to any direct service agreement between Parents and Professionals.</p>
          </Section>
          ...
          <Section title="5. Professional Responsibility Disclaimer">
            <p>Includly acts solely as a marketplace platform. We do not employ, endorse, guarantee, or assume responsibility for any Professional listed on the Platform. Parents are solely responsible for:</p>
            <ul>
          ...
          <Section title="9. Intellectual Property">
            <p>All content on the Platform, including the Includly name, logo, design, and software, is owned by Includly and protected by intellectual property laws. You may not reproduce or distribute our content without written permission.</p>
          </Section>

          <Section title="10. Limitation of Liability">
            <p>To the maximum extent permitted by applicable law, Includly shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the Platform or any services obtained through it.</p>
          </Section>
          ...
          <Section title="13. Contact">
            <p><strong>Includly</strong><br />Email: <a href="mailto:legal@includly.in">legal@includly.in</a></p>
          </Section>
        </div>
      </div>
    </div>
